...
public class CreateDeviceAdminTest extends MainMetods {
    ...
    public void SonoCollect_110FtpPassive() throws InterruptedException {
        ...
        tr.findElement(By.xpath("td[3]/div/div/input")).sendKeys("2221");//переписать нормально
        Thread.sleep(1000);

        System.out.println("Enter IPv4");
        tr.findElement(By.xpath("td[4]/div/div/input")).sendKeys("test11");//переписать нормально
        Thread.sleep(1000);
        ...
        driver.findElement(By.xpath("//td[@value='test11']/..//span[text()='edit']")).click();
        Thread.sleep(1000);
