...
public class Danfoss_SonoCollect_110_HttpEcl4 {
    ...
    public void SonoCollect_110FtpPassive() throws InterruptedException {
        ...
        tr.findElement(By.xpath("td[2]/div/div/input")).sendKeys("test5");
        Thread.sleep(1000);

        System.out.println("Enter Пароль");
        tr.findElement(By.xpath("td[3]/div/div/input")).sendKeys("test5");//переписать нормально
        Thread.sleep(1000);

        System.out.println("Enter IPv4");
        tr.findElement(By.xpath("td[4]/div/div/input")).sendKeys("test5");//переписать нормально
        Thread.sleep(1000);
        ...
        driver.findElement(By.xpath("//td[@value='test5']/..//span[text()='edit']")).click();
        Thread.sleep(1000);
