...
public class Danfoss_INDIV_X_TOTAL_LocalStorage {
    ...
    public void SonoCollect_110FtpPassive() throws InterruptedException {
        ...
        tr.findElement(By.xpath("td[2]/div/div/input")).sendKeys("test9");
        Thread.sleep(1000);

        System.out.println("Enter Пароль");
        tr.findElement(By.xpath("td[3]/div/div/input")).sendKeys("test9");//переписать нормально
        Thread.sleep(1000);

        System.out.println("Enter IPv4");
        tr.findElement(By.xpath("td[4]/div/div/input")).sendKeys("test9");//переписать нормально
        Thread.sleep(1000);
        ...
        driver.findElement(By.xpath("//td[@value='test9']/..//span[text()='edit']")).click();
        Thread.sleep(1000);
