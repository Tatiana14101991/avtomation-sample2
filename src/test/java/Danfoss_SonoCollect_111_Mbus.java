...
public class Danfoss_SonoCollect_111_Mbus {
    ...
    public void Danfoss_SonoCollect_111_Mbus() throws InterruptedException {
        ...
        Thread.sleep(1000);
        driver.findElement(By.xpath("//li[contains(text(),'Danfoss_SonoCollect_111')]")).click();
        ...
        tr.findElement(By.xpath("td[2]/div/div/input")).sendKeys("test54");
        Thread.sleep(1000);

        System.out.println("Enter Пароль");
        tr.findElement(By.xpath("td[3]/div/div/input")).sendKeys("test54");//переписать нормально
        Thread.sleep(1000);
        ...
        Thread.sleep(3000);
        driver.findElement(By.xpath("//td[@value='test54']/..//span[text()='edit']")).click();
