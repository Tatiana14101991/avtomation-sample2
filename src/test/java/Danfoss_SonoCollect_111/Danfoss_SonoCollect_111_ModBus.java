...
public class Danfoss_SonoCollect_111_ModBus extends MainMetods {
    ...
    @Test
    public void Danfoss_SonoCollect_111_ModBus() throws InterruptedException {
        ...
        tr.findElement(By.xpath("//tr[2]/td[2]/div/div/input")).sendKeys("test576");//переписать нормально
        Thread.sleep(1000);
        ...
        tr.findElement(By.xpath("//tr[2]/td[5]/div/div/input")).sendKeys("test576");//переписать нормально
        Thread.sleep(1000);
        ...
        Thread.sleep(3000);
        driver.findElement(By.xpath("//td[@value='test576']/..//span[text()='edit']")).click();
