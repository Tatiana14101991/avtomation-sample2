...
public class Pulsar_MBus_Converter_MBus {
    ...
    public void SonoCollect_110FtpPassive() throws InterruptedException {
        ...
        tr.findElement(By.xpath("td[3]/div/div/input")).sendKeys("test18");//переписать нормально
        Thread.sleep(1000);
        ...
        driver.findElement(By.xpath("//td[@value='test18']/..//span[text()='edit']")).click();
        Thread.sleep(1000);
